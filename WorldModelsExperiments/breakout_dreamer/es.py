...
class CMAES:
  ...
  # asks optimizer to give set of candidate solutions
  def ask(self):
    '''returns a list of parameters'''
    self.solutions = np.array(self.es.ask())
    return self.solutions

  # gives list of fitness results back to CMA-ES optimizer
  ...
  # returns current results from es
  ...
  # returns best set of parameters
  def best_param(self):
